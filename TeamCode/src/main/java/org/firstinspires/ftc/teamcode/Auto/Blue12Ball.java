...
public class Blue12Ball extends LinearOpMode {
    ...
    public void runOpMode() {
        ...
        Pose2d collectRow1 = new Pose2d(10.4, 10.0, Math.toRadians(90));
        Pose2d finishRow1 = new Pose2d(10.4, 47.0, Math.toRadians(90));
        Pose2d collectRow2 = new Pose2d(-6.5, 5.0, Math.toRadians(90));
        Pose2d finishRow2 = new Pose2d(-6.5, 50.0, Math.toRadians(90));
